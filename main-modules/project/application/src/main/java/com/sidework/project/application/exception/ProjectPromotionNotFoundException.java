...
public class ProjectPromotionNotFoundException extends GlobalException {
	public ProjectPromotionNotFoundException(Long promotionId, Long userId) {
		super(ErrorStatus.PROJECT_PROMOTION_NOT_FOUND.withDetail("유저아이디: "+ userId + "홍보글 아이디: "+ promotionId + "인 프로젝트 홍보글을 찾을 수 없습니다."));
	}
}
